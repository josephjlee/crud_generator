...
class Tabel_menu_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id,judul_menu,link,icon,is_main_menu');
        $this->datatables->from('tabel_menu');
        //add this line for join
        //$this->datatables->join('table2', 'tabel_menu.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('tabel_menu/read/$1'),'Read')." | ".anchor(site_url('tabel_menu/update/$1'),'Update')." | ".anchor(site_url('tabel_menu/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
