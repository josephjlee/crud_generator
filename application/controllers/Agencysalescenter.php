...
class Agencysalescenter extends CI_Controller
{
    ...
    {
        $this->load->view('agencysalescenter/agencysalescenter_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Agencysalescenter_model->json();
    }
    ...
    public function read($id) 
    {
		...
		'ReasonEnd' => $row->ReasonEnd,
            ...
            $this->load->view('agencysalescenter/agencysalescenter_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('agencysalescenter/agencysalescenter_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('agencysalescenter/agencysalescenter_doc',$data);
    }
